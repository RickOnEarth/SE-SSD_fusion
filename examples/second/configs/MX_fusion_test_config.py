...
test_anno = data_root_prefix + "/kitti_se-ssd/kitti_infos_val.pkl"
...
#load_from = "/mengxing/LiDAR_Detection/SE-SSD/model_dir/second/pretrained_model/se-ssd-model.pth"
load_from = "/mengxing/LiDAR_Detection/SE-SSD/model_dir/second/pretrained_model/epoch_60.pth"
#load_from = None
resume_from = None
...
fusion_test_cfg = dict(
    load_from='/mengxing/LiDAR_Detection/SE-SSD/model_dir/fusion_second/work_dir_bak/fusion_layer-40832.tckpt',
    results_save_dir='/mengxing/LiDAR_Detection/SE-SSD/model_dir/fusion_second/results'
)
