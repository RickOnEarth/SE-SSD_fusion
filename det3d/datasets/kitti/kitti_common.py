...
def MX_raw_data_create_kitti_info_file(data_path, save_path=None, relative_path=True):
    test_img_ids = _read_imageset_file(str(data_path + "/testing/test.txt"))
...
def MX_raw_data_create_reduced_point_cloud(
    data_path,
    train_info_path=None,
    val_info_path=None,
    test_info_path=None,
