...
def kitti_data_prep(root_path):
    ...
    #kitti_ds.MX_raw_data_create_kitti_info_file(root_path)
    kitti_ds.MX_raw_data_create_reduced_point_cloud(root_path)
...
if __name__ == "__main__":
    #fire.Fire()
    kitti_data_prep("/mengxing/Data/Sets/raw_data/SE-SSD_preprocess/object_format_2011_09_26_drive_0005")
